...
- Muninn：更偏“可互操作的格式 + 服务”，强调统一 `memoryId` 与 text-first MCP（Markdown 渲染）。

## 数据与接口粒度

| 维度 | claude-mem | Muninn |
|---|---|---|
| 基本记录粒度 | point memory / session summary | 当前以 session/extraction memory rows 为主 |

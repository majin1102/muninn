...
export const demoPipelineTasks: DemoPipelineTask[] = [
  {
    ...
    inputSummary: '16 extractions from 3 turns',
  ...
  },
  {
    ...
    outputSummary: '12 extractions',
    inputDetails: ['100 turn window', 'agent: codex'],
    outputDetails: ['12 extractions', 'queued global work'],
    trace: [
      'read turns: done',
  ...
  },
  {
    ...
    inputSummary: '5 extractions',
    outputSummary: 'Global observation draft',
    inputDetails: ['5 extractions', 'below observer threshold'],
  ...
  },
  {
    ...
    inputSummary: '8 extractions',
    outputSummary: 'Blocked by parser validation',
    inputDetails: ['8 extractions', 'retry retained'],

...
**Goal:** Add repeatable Codex and Claude E2E tests that verify import, real hook capture, session deletion, project deletion, and capture-disabled behavior with mock drivers in CI and opt-in real host drivers locally.
...
- Create `scripts/e2e/assertions.mjs`
  - Polling and assertion helpers for import projects, sessions, and turns.
...
- Modify `.github/workflows/codex-ci.yml`
  - Run mock Codex E2E after package tests.
- Modify `.github/workflows/claude-ci.yml`
  - Run mock Claude E2E after package tests.

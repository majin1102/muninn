...
参考（Munnai 当前规范）：
- [spec/munnai-mcp-api.md](/Users/Nathan/workspace/munnai/spec/munnai-mcp-api.md)
- [spec/munnai-format-schema.md](/Users/Nathan/workspace/munnai/spec/munnai-format-schema.md)
...
- **统一定位键**：Munnai 当前通过 `memoryId` 做统一读取导航。
- **广度/深度**：
